...
[_RAISE] = LAYOUT_planck_grid(
    ...
    KC_TAB,   KC_EXLM, KC_AT,    KC_HASH, KC_DLR,  KC_PERC, KC_PLUS, KC_4,    KC_5,    KC_6,    KC_SLSH, KC_EQL,
    KC_LSFT,   KC_QUES, KC_AMPR, KC_ASTR, KC_TILD, KC_UNDS, KC_MINS, KC_1,    KC_2,    KC_3,    KC_ASTR, UC(0x005C),
